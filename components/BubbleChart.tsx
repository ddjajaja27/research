    ...
    return (
      <div className="w-full h-[400px] bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 relative animate-pulse">
           {/* Skeleton Axis */}
           <div className="absolute left-8 top-0 bottom-8 w-0.5 bg-gray-200 dark:bg-gray-700"></div>
           <div className="absolute left-8 right-0 bottom-8 h-0.5 bg-gray-200 dark:bg-gray-700"></div>
           
           {/* Skeleton Bubbles */}
           <div className="absolute top-1/3 left-1/4 w-16 h-16 bg-gray-200 dark:bg-gray-700 rounded-full opacity-60"></div>
           <div className="absolute top-1/2 left-2/3 w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-full opacity-40"></div>
           <div className="absolute top-20 right-20 w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-full opacity-70"></div>
           <div className="absolute bottom-20 left-20 w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full opacity-50"></div>
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
             <div className="bg-white/90 dark:bg-gray-800/90 px-4 py-2 rounded-full shadow-sm backdrop-blur-sm flex items-center border border-gray-100 dark:border-gray-600">
                ...
                <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Visualizing clusters...</span>
             </div>
        </div>
      </div>
    );
